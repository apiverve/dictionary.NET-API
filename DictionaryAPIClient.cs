...
namespace APIVerve
{
    public class DictionaryAPIClient
    {
        ...
        public DictionaryAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public DictionaryAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(dictionaryQueryOptions options)
        {
            try
            {
                if (_isDebug)
